#!/usr/bin/env python3
"""
Working AI Assistant - Actually Performs Tasks on Your Computer
A real AI assistant that can do anything on your computer.
"""
...
class WorkingAIAssistant:
    def __init__(self):
        print("🔧 Initializing Working AI Assistant...")
        ...
        print("✅ Working AI Assistant initialized successfully!")
    ...
    def show_assistant(self):
        ...
        print("🎯 Showing Working AI Assistant...")
        ...
        try:
            ...
            self.assistant_window.title("Working AI Assistant")
            ...
            self.assistant_window.geometry(f"900x700+{x}+{y}")
            ...
            self.input_entry = ctk.CTkEntry(
                input_frame,
                placeholder_text="Ask me to do anything! (e.g., 'open notepad', 'search for files', 'open browser and search Google API limits')",
            ...
            # Add welcome message
            self._add_message("AI Assistant", "Hello! I'm your Working AI Assistant. I can ACTUALLY perform tasks on your computer:\n\n🔧 System Tasks:\n• Open applications (notepad, calculator, paint, etc.)\n• Search files on your computer\n• Get system information\n• Control your computer\n\n🌐 Web Tasks:\n• Open browser and search\n• Navigate to websites\n• Search for information\n\n📁 File Operations:\n• Find files and folders\n• Navigate directories\n• Search for documents\n\nJust ask me to DO something and I'll actually do it!", "assistant")
            
            print("✅ Working AI Assistant interface created successfully")
    ...
    def hide_assistant(self, event=None):
        ...
        print("🎪 Hiding Working AI Assistant...")
...
"""
    ...
    def _handle_system_commands(self, command):
            ...
            for app_name, app_path in apps.items():
                if app_name in command_lower:
                    try:
                        ...
                        return f"✅ Actually opened {app_name} for you!"
                    except Exception as e:
                        return f"❌ Error opening {app_name}: {e}"
        
        # Web browser commands
        if any(word in command_lower for word in ["search", "google", "browser", "web"]):
            if "search" in command_lower:
                ...
                if search_query:
                    try:
                        ...
                        return f"✅ Actually opened browser and searched for: '{search_query}'"
                    except Exception as e:
                ...
                try:
                    ...
                    return "✅ Actually opened Google in your browser!"
                except Exception as e:
                    return f"❌ Error opening browser: {e}"
        
        # File search commands
        if "search for files" in command_lower or "find files" in command_lower:
            try:
                # Open file explorer to search
                subprocess.run(["explorer", "/select,"], shell=True)
                return "✅ Actually opened File Explorer for you to search files!"
            except Exception as e:
        ...
        if any(word in command_lower for word in ["system info", "system information", "computer info"]):
            info = f"""
🖥️ Actually getting your system information:
...
"""
        ...
        if any(word in command_lower for word in ["what can you do", "help", "capabilities"]):
            return """
🤖 I can ACTUALLY do these tasks on your computer:
...
🎯 Just ask me to DO something and I'll actually do it!
"""
    ...
    def _get_demo_response(self, command):
        ...
        if "open" in command_lower:
            return "I can actually help you open applications! Try saying 'open notepad' or 'open calculator' and I'll do it."
        
        elif "search" in command_lower:
            return "I can actually open your browser and search! Try saying 'search for Google API limits' and I'll open the browser and search for you."
        
        elif "system" in command_lower:
            return f"Here's your actual system info:\n• OS: {self.system_info['os']}\n• Username: {self.system_info['username']}\n• Current directory: {self.system_info['current_dir']}"
        
        elif "help" in command_lower or "what can you do" in command_lower:
            return "I'm your Working AI Assistant! I can actually open apps, search the web, find files, and control your computer. Just ask me to DO something!"
        
        else:
            return f"I understand you said: '{command}'. I can actually perform tasks on your computer. Try asking me to open an app, search the web, or find files!"
    ...
    def run(self):
        """Run the application"""
        print("🚀 Starting Working AI Assistant main loop...")
        
        try:
            # Use tkinter mainloop
            self.hidden_root.mainloop()
        except KeyboardInterrupt:
            print("\n🛑 Shutting down Working AI Assistant...")
            self.shutdown()
        except Exception as e:
    ...
    def shutdown(self):
        """Clean shutdown"""
        print("🛑 Shutting down Working AI Assistant...")
